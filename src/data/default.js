export const DEFAULT = {
    ...
    address: 'Graff France Headquarters 237 rue Saint-Honore Paris 75001',
    service: [
        { title: '이용약관', link: '/' },
        { title: '문의하기', link: '/' },
...
export const DEFAULT_CONTENTS = [
    {
        ...
        description: "모던하면서도 클래식한 디자인들을 완벽하게 표현한 그라프 하우스의 시그너쳐 컬렉션은 다양한 컷, 스톤 그리고 색상들을 멋진 조합으로 선사합니다. ",
        color: '#336699',
    },
    {
        ID: 2,
